...
def main() -> int:
    ...
    L.append("| Legacy | Now |")
    L.append("|---|---|")
    L.append("| `D4a` | §2 of [ADR-0004](tools/0004-no-arbitrary-code-execution-in-v1.md) |")
    L.append("| `D7b` | §2 of [ADR-0007](tools/0007-the-tool-gateway-is-a-separate-service.md) |")
