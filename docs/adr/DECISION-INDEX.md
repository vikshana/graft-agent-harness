...
| [ADR-0049](platform/0049-two-independent-regional-deployments.md) | Two independent regional deployments | 🟢 accepted | 2026-09-13 | supersedes ; **superseded by** ; amends ; amended by [ADR-0075](platform/0075-organisation-policy-governs-model-and-serving-selection.md) |
...
| [ADR-0075](platform/0075-organisation-policy-governs-model-and-serving-selection.md) | Organisation policy governs model and serving selection | 🟢 accepted | 2026-09-17 | amends [ADR-0049](platform/0049-two-independent-regional-deployments.md), [ADR-0057](tenancy/0057-budget-ceilings-are-per-scope-with-distinct-at-cap-behaviour.md) |
...
| [ADR-0076](agent/0076-recovery-requires-confirmed-termination-or-an-independent-fence.md) | Recovery requires confirmed termination or an independent fence | 🟡 proposed | 2026-09-18 | amends [ADR-0038](agent/0038-work-rediscovery-is-ours-to-build.md) |
| [ADR-0077](agent/0077-auto-versioning-must-account-for-dependency-upgrades.md) | Auto-versioning must account for dependency upgrades | 🟡 proposed | 2026-09-18 | amends [ADR-0046](agent/0046-deploy-strategy-is-blue-green-on-dbos-application-version.md) |
...
| [ADR-0057](tenancy/0057-budget-ceilings-are-per-scope-with-distinct-at-cap-behaviour.md) | Budget ceilings are per-scope with distinct at-cap behaviour | 🟢 accepted | 2026-09-13 | amends [ADR-0017](tenancy/0017-limits-form-a-ceiling-chain.md); amended by [ADR-0075](platform/0075-organisation-policy-governs-model-and-serving-selection.md) |
...
Mechanism: [`../design/observability-pipeline.md`](../design/observability-pipeline.md)
...
| [ADR-0074](observability/0074-langfuse-is-the-internal-evaluation-sink.md) | Langfuse is the internal evaluation sink | 🟢 accepted | 2026-09-17 | supersedes ; **superseded by** ; amends [ADR-0008](observability/0008-instrumentation-is-openlit-plus-hand-written-spans-over-otlp.md), [ADR-0071](observability/0071-two-telemetry-sinks-with-an-internal-only-eval-sink.md); amended by  |
